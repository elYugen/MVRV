                        ...
                        <tr key={news._id}>
                            ...
                            <td>
                                <div className={styles.buttonContainer}>
                                    <button onClick={() => openModal(news._id)} className={styles.UserButton}>Lire</button>
                                    <button onClick={() => openEditModal(news._id)} className={styles.UserButton}>
                                        Éditer
                                    </button>
                                    <button onClick={() => openDeleteModal(news._id)} className={styles.UserButton}>
                                        Supprimer
                                    </button>
                                </div>
                            </td>
