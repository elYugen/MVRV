                        ...
                        <tr key={heros._id}>
                            ...
                            <td>
                                <div className={styles.buttonContainer}>
                                    <button onClick={() => openModal(heros._id)} className={styles.UserButton}>Voir</button>
                                    <button onClick={() => openDeleteModal(heros._id)} className={styles.UserButton}>Supprimer</button>
                                </div>
                            </td>
                        </tr>
                    ))}
